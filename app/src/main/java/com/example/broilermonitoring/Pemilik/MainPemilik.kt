...
import com.example.broilermonitoring.databinding.ActivityMainPemilikBinding

class MainPemilik : AppCompatActivity() {
    private lateinit var binding:ActivityMainPemilikBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding= ActivityMainPemilikBinding.inflate(layoutInflater)
