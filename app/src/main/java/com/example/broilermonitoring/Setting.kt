...
import com.example.broilermonitoring.databinding.FragmentSettingBinding
...
class Setting : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.password0.setOnClickListener {
            val intent = Intent(requireContext(), Password::class.java)
            startActivity(intent)
        }
        binding.panduan.setOnClickListener {
            val intent = Intent(requireContext(), PanduanAplikasi::class.java)
            startActivity(intent)
        }
