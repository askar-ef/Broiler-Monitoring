...
import com.example.broilermonitoring.databinding.FragmentKlasifikasiBinding
 ...
 * Use the [Klasifikasi.newInstance] factory method to
 * create an instance of this fragment.
 */
class Klasifikasi : Fragment() {
    // TODO: Rename and change types of parameters
    private var param1: String? = null
    private var param2: String? = null
    private lateinit var binding: FragmentKlasifikasiBinding
    ...
    override fun onCreateView(
        ...
        with(binding){
            klasifikasiBackbutton.setOnClickListener {
    ...
    companion object {
         ...
         * @return A new instance of fragment Klasifikasi.
         */
